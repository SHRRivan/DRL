...
class Monitor(gym.Wrapper):
    ...
    def reset(self, **kwargs):
        ...
        return reset_obs if not isinstance(reset_obs, int) else np.array([reset_obs])
    ...
    def step(self, action: Union[np.ndarray, int]):
        ...
        if isinstance(action, np.ndarray) and isinstance(self.env.action_space, gym.spaces.Discrete):
            action = action.item()
        ...
        return observation, np.array([reward]), done, [info]
